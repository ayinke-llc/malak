...
export const UPDATE_INVESTOR_IN_PIPELINE = 'UPDATE_INVESTOR_IN_PIPELINE' as const;
export const UPDATE_CONTACT_COLUMN_PIPELINE = 'UPDATE_CONTACT_COLUMN_PIPELINE' as const;
