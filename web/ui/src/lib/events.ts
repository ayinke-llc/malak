export enum AnalyticsEvent {
  LoginButtonClicked = "EVENT_LOGIN_BUTTON_CLICKED",
  DuplicateUpdate = "EVENT_UPDATE_DUPLICATE",
  DeleteUpdate = "EVENT_UPDATE_DELETE",
  ...
  SignupButtonClicked = "EVENT_SIGNUP_BUTTON_CLICKED"
}
